...
_DISPLAY_MSG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='version', full_name='DISPLAY_MSG.version', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='typ', full_name='DISPLAY_MSG.typ', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='dim_x', full_name='DISPLAY_MSG.dim_x', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='dim_y', full_name='DISPLAY_MSG.dim_y', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pixel_list', full_name='DISPLAY_MSG.pixel_list', index=4,
...
_DISPLAY_RESPONSE = _descriptor.Descriptor(
  ...
  full_name='DISPLAY_RESPONSE',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='success', full_name='DISPLAY_RESPONSE.success', index=0,
...
DISPLAY_RESPONSE = _reflection.GeneratedProtocolMessageType('DISPLAY_RESPONSE', (_message.Message,), dict(
  ...
  __module__ = 'display_server_pb2'
  # @@protoc_insertion_point(class_scope:DISPLAY_RESPONSE)
  ))
...
_WS2801_DISPLAY = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='DISPLAY_CHANGE',
    full_name='WS2801_Display.DISPLAY_CHANGE',
    index=0,
